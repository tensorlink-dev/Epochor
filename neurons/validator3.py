...
from neurons.validator2 import ValidatorState, ModelManager, WeightSetter, should_retry_model
...
# Epochor Imports
from epochor.dataloaders import DatasetLoaderFactory, SubsetLoader, EvalSample
                ...
                try:
                    ...
                    with compute_loss_perf.sample():
                        score, score_details = utils.run_in_subprocess(
                            functools.partial(
                                epochor.rewards.score_time_series_model, model_i, Evaluator(), samples, self.config.device, seed
                            ),
                            ttl=550, mode="spawn"
                        )
                    del model_i
